---
name: threat-model
description: "Use this skill BEFORE performing any security analysis, vulnerability hunting, or code audit. Triggers when the user asks to review code for security, find vulnerabilities, perform a security audit, or do a pentest of source code. This skill MUST run first to establish the threat model — without it, vulnerability findings will be generic noise. Also use when the user explicitly asks to build a threat model, define trust boundaries, or scope a security engagement. Do NOT use for general code review focused on quality/maintainability rather than security."
license: MIT
metadata:
  author: kylejryan
  version: "1.0.0"
  ...
  date: March 2026
  abstract: "Structured threat model construction that must precede any vulnerability analysis. Defines system identity, trust boundaries, attacker profiles, and impact calibration to ensure findings are prioritized rather than pattern-matched."
---
