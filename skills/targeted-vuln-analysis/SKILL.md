...
metadata:
  ...
  date: March 2026
  abstract: "Depth-first vulnerability analysis methodology that requires a threat model as input and enforces proven exploitability for all findings. Prevents breadth-first pattern-matching hallucination by mandating concrete source-to-sink traces, payload construction, and explicit confidence calibration."
---
